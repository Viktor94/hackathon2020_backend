...
public class EmailTemplateService {
    ...
    public static String LESS_THEN_FIVE_MIN_NOTIFICATION_EMAIL(User user, Integer lunchtimeLeftInMinute){
        String htmlString = readHtml("lessThenfiveMinNotificationTemplate.html");
        String htmlReplacedData = htmlString.replace("[USERNAME]", user.getUserName()).replace("[LEFT_TIME]", String.valueOf(lunchtimeLeftInMinute));
        return htmlReplacedData;
    }
